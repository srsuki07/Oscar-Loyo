...
st.set_page_config(page_title="Mi chat de IA por Oscar Loyo", page_icon="🗣")
st.title("El Primer ChatBot de Suki")

nombre = st.text_input("¿Como te llamas?")
if st.button("Saludar!"):
    st.write(f"Hola {nombre}! Espero disfrutes tu estadia :)")

MODELOS = ['llama-3.1-8b-instant', 'llama-3.3-70b-versatile']

def configurar_pagina():
    st.title("Mi Chat de IA por Oscar Loyo")
